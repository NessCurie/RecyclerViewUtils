...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
        ...
        int anInt = a2.getInt(R.styleable.SwipyRefreshLayout_refresh_mode, 0);
        if (anInt != BOTH) {
            mDirection = anInt;
    ...
    /**
     * @deprecated Use {@link #setColorSchemeColors(int...)}
     */
    @Deprecated
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mBothDirection) {
                    ...
                    if ((mDirection == BOTTOM && canChildScrollDown())
                            || (mDirection == TOP && canChildScrollUp())) {
                        mInitialDownY = y;
                        return false;
                    }
                }
